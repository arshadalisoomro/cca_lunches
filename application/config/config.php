 ...
 */
define('URL', 'http://www.ccalunches.com/');
...
define('COOKIE_DOMAIN', '.erictotten.info');
...
define("EMAIL_PASSWORD_RESET_FROM_EMAIL", "support@ccalunches.com");
define("EMAIL_PASSWORD_RESET_FROM_NAME", "CCA Lunch Ordering");
define("EMAIL_PASSWORD_RESET_SUBJECT", "Password reset for CCA Lunch Ordering");
define("EMAIL_PASSWORD_RESET_CONTENT", "Please click on this link to reset your password: ");

define("EMAIL_VERIFICATION_URL", URL . "login/verify");
define("EMAIL_VERIFICATION_FROM_EMAIL", "no-reply@ccalunches.com");
define("EMAIL_VERIFICATION_FROM_NAME", "CCA Lunch Ordering");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for CCA Lunch Ordering");
define("EMAIL_VERIFICATION_CONTENT", "Please click on this link to activate your account: ");
